...
type LoginResponse struct {
	...
	// Identifier of available tournament
	// Required: true
...
func (m *LoginResponse) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateTournamentID(formats); err != nil {
		res = append(res, err)
	}
...
func (m *LoginResponse) validateTournamentID(formats strfmt.Registry) error {

	if err := validate.Required("tournament_id", "body", m.TournamentID); err != nil {
		return err
	}
